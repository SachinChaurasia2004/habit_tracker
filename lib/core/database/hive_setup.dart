...
class HiveSetup {
  ...
  static Box<UserProfileModel> get profileBox {
    return Hive.box<UserProfileModel>('user_profile');
  }
  ...
  static Future<Map<String, int>> getDatabaseStats() async {
    return {'habits': habitsBox.length, 'entries': entriesBox.length, 'profile': profileBox.length};
  }
